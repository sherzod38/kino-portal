...
const SingleMovies = ({ match }) => {
  ...
  function formatNums(son) {

    // return  [...String(son)]

    // let sonArr = [...String(son)]
    // return sonArr
    
    let sonArr = [...`${son}`].reverse();
    for (let i = 0; i < sonArr.length; i +=4)
        sonArr.splice(i, 0, ' ')
    return sonArr.reverse()
        ...
        <div className="movie-info">
          ...
          <div className="movie-info-front containers">
            ...
            <div className="front-info">
                ...
                <h4>Budget: ${ formatNums (movieInfoData.budget) }</h4>
                <h4>
